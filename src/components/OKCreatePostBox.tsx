...
const OKCreatePostBox = () => {
    return (
        <View style={t`rounded-lg bg-white flex flex-col p-3 px-4 shadow border border-gray-300`}>
            <View style={t`flex-row items-center border-b pb-3 mb-2`}>
                ...
                <Pressable style={(state) => [t`focus:bg-gray-300 focus:outline-none flex-grow bg-gray-100 text-gray-500 text-left pl-2 rounded-full h-10 pl-5`, state.hovered && t`bg-gray-200`]}>
